...
const ConformUserSelection = props => {
  ...
  return (
    <div style={{ display: visibilityState }} className="wrapper-conform">
      <p className="msg-conform">Are You Sure About Your Selection </p>
      <button className="conform-btn" onClick={props.submit}>
        Submit
      </button>
      <button className="cancel-conform-btn" onClick={props.cancel}>
        Cancel
      </button>
    </div>
  );
